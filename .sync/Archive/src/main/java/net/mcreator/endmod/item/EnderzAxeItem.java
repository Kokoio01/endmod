...
public class EnderzAxeItem extends EndmodModElements.ModElement {
	@ObjectHolder("endmod:enderz_axe")
	public static final Item block = null;
	public EnderzAxeItem(EndmodModElements instance) {
		super(instance, 14);
	}
