...
public class EnderFenceGateBlock extends EndmodModElements.ModElement {
	@ObjectHolder("endmod:ender_fence_gate")
	public static final Block block = null;
	public EnderFenceGateBlock(EndmodModElements instance) {
		super(instance, 32);
	}
