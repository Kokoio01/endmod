...
public class EnderzPickaxeItem extends EndmodModElements.ModElement {
	@ObjectHolder("endmod:enderz_pickaxe")
	public static final Item block = null;
	public EnderzPickaxeItem(EndmodModElements instance) {
		super(instance, 13);
	}
