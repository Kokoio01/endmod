...
public class EnderzHoeItem extends EndmodModElements.ModElement {
	@ObjectHolder("endmod:enderz_hoe")
	public static final Item block = null;
	public EnderzHoeItem(EndmodModElements instance) {
		super(instance, 17);
	}
